...
private func drawAccentGradient(in context: CGContext, rect: CGRect) {
    let colors = [
        CGColor(red: 1.0, green: 0.42, blue: 0.78, alpha: 1.0),
        CGColor(red: 1.0, green: 0.58, blue: 0.86, alpha: 1.0),
...
private func renderIcon(pixelSize: Int) -> NSImage {
    ...
    drawAccentGradient(in: context, rect: rect)
